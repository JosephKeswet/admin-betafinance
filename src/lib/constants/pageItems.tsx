  ...
  overview_table: [
    {
        ...
        rows: [
            ...
            { holder: {id: "1", icon: Icon.Minus, initial: "JD", name: "John Doe", username: "@eroberts"}, email: "eroberts@gmial.com", noOfLoan: "84" },
            { holder: {id: "1", icon: Icon.ArrowDown, initial: "JD", name: "John Doe", username: "@eroberts"}, email: "eroberts@gmial.com", noOfLoan: "84" },
            { holder: {id: "1", icon: Icon.ArrowUp, initial: "JD", name: "John Doe", username: "@eroberts"}, email: "eroberts@gmial.com", noOfLoan: "84" },
            { holder: {id: "1", icon: Icon.ArrowUp, initial: "JD", name: "John Doe", username: "@eroberts"}, email: "eroberts@gmial.com", noOfLoan: "84" },
        ]
    },
